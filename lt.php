...
<head>
    ...
    <title>flower ⎯ gαleriedeperles</title>
</head>
...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - flower</p>
    <img src="img/polos flower.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">flower beads bracelet</h3>
    </br>
    <h10>start 8.OOO</h10>
    <h9>gelang seri ini ini dapat membantu menambah energi hidup, dan mencerahkan 
    </br>suasana kehidupan Anda :)</h9>
