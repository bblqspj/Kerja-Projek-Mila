...
<head>
    ...
    <title>ribbon ⎯  gαleriedeperles</title>
</head>
...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - ribbon</p>
    <img src="img/polos ribbon.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">ribbon beads bracelet</h3>
    </br>
    <h10>start 8.OOO</h10>
    <h9>jika Anda menyukai desain gelang saya, inilah tempatnya!
    </br></br>bundel gelang pita ini di toko saya :”)
    </br></br>selamat menggunakan ~</h9>
