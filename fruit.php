...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - fruit</p>
    <img src="img/fruit/polos fruit.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">fruit beads bracelet</h3>
    </br>
    <h10>start 8.OOO</h10>
    <h9>jika kalian melihat rencana si kupu kupu, pernahkah kalian mencari tahu 
    </br>bagaimana sayap mereka bisa seindah itu? gelang seri ini jawaban nya!
    </br>whitey dan pinky sangat suka menghirup sari buah yang sangat manis . . .
    </br>jangan lupa untuk ber cermin dan lihat pantulan dicermin itu, terlihat 
    </br>wajah seseorang yang tak kalah indah dari sayap si kupu kupu ^^ 
