...
<head>
    ...
    <title>phone strap ⎯ gαleriedeperles</title>
</head>
...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - phone strap</p>
    <img src="img/ps/polos ps.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">phone strap</h3>
    </br>
    <h10>start 1O.OOO</h10>
    <h9>untuk menghias handphone, koleksi buku, binder, taploader, keychain, dll
    </br></br></br>notes :
    </br></br>
   ・whitey ribbon
    </br>
