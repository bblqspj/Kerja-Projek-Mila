...
<head>
    ...
    <title>love (b) ⎯ gαleriedeperles</title>
</head>
...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - love(b)</p>
    <img src="img/love/polos love.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">love(b) beads bracelet</h3>
    </br>
    <h10>start 1O.OOO</h10>
    <h9>simbol hati yang diabadikan di seri ini!, dapat bermakna jika dipakai 
    </br>setiap hari. Meskipun seri ini tidak menceritakan kisah tertentu, 
    </br>kesederhanaan modelnya dapat membuatnya dapat diterapkan pada
    </br>siapa pun. saya harap model sederhana ini dapat mengingatkan anda
    </br>untuk memperhatikan hal-hal kecil yang paling dekat dengan anda!
    </br></br></br>note on the bracelet :
    </br></br>
    ・whitey untuk varian putih
    </br>
