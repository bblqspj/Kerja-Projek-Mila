...
<head>
    ...
    <title>love (a) ⎯ gαleriedeperles</title>
</head>
...
<header class="header">
   ...
   <img src="logoapkkpbaru.jpg" class="img" width="5%" height="5%"></img>
    ...
    <p class="desc">shop - love (a)</p>
    <img src="img/love2/polos love2.jpg" style="width: 500px; height: 500px;" alt="">
    <h3 style="letter-spacing: 6px;">love(a) beads bracelet</h3>
    </br>
    <h10>start 8.OOO</h10>
    <h9>saya ingin membuat gelang yang dapat memberikan makna bagi siapa pun. 
    </br>Saya menambahkan kesan reflektif pada kedua model gelang ini dengan
    </br>harapan orang lain dapat meluangkan waktu untuk merenungkan kesan -
    </br>kesan ini agar merasa lebih menghargai setiap hari
