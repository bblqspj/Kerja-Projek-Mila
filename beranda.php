...
<a href="cart.php" class="cart"><i class="fa-solid fa-cart-shopping" style="font-size: 20px;"></i></a>
    ...
    <div class="product">
        <a href="pwlove.php" alt="">
            <img src="img/love2/polos love2.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>love (a) beαds brαcelet</h2>
        <p> stαrt 1O.OOO</p>
    </div>

    <div class="product">
        <a href="loveb.php" alt="">
            <img src="img/love/polos love.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>love (b) beαds brαcelet</h2>
        <p> stαrt 1O.OOO</p>
    </div>

    <div class="product">
        <a href="pwfairy.php" alt="">
            <img src="img/fairy/polos fairy.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>fairy beαds brαcelet</h2>
        <p> stαrt 1O.OOO</p>
    </div>

    <div class="product">
        <a href="spider.php" alt="">
            <img src="img/couple/polos couple.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>couple beads bracelet</h2>
        <p> stαrt 1O.OOO</p>
    </div>

    <div class="product">
        <a href="fruit.php" alt="">
            <img src="img/fruit/polos fruit.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>fruit beads bracelet</h2>
        <p> stαrt 8.OOO</p>
    </div>

    <div class="product">
        <a href="ps.php" alt="">
            <img src="img/ps/polos ps.jpg" style="width: 300px; height: 300px;" alt=""> 
        </a>
        <h2>phone strap</h2>
        <p> stαrt 1O.OOO</p>
    </div>
